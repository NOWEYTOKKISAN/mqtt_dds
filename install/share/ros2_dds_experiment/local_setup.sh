...
: ${AMENT_CURRENT_PREFIX:="/media/psf/Home/대학/LAB/ROS2&MQTT/performanceComparison/install"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_dds_experiment/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_dds_experiment/environment/path.sh"
